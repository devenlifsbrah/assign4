...
const upload = multer({ storage: storage });
 ...
 app.get('/images', function (req, res) {
	 ...
	 res.render("addImage", {images:items});
});
	  });
...
console.log(req.body);
 data.update(req.body).then(function(succ){
  ...
  app.get('/employees/:value', function (req, res) {
	       data.num(req.params.value).then(function(succ){
			   console.log(succ[0]);
		 res.render("updateEmployee", { employee: succ[0],
                                        nums:req.params.value		 }); 
   ...
   app.get('/employees', function (req, res) {
	  ...
	  if(req.query.manager != 'undefined'){
		 ...
		 // use req.query.status value
	      ...
	      res.render("employees", {person:succ});
 ...
 app.post('/employees/add', function (req, res) {
  ...
  app.get('/departments', function (req, res) {
	      ...
	      res.render("departments", {person:succ});
